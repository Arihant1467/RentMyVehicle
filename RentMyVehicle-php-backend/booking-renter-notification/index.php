										...
										<td width="200" valign="top" align="center">
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" >
													<img src="http://res.cloudinary.com/arihant95/image/upload/v1493750870/rent-a-tech_gnrsql.jpg" width="155" height='155' alt='Logo'  data-default="placeholder" />
												</div>
											</div>
										</td>
										<td width="200" valign="top">&nbsp;</td>
								...
								<table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
									...
									<tr>
										...
										<td width="400" align="center" style="padding-bottom:5px;">
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" >
                                                    <p >Your vehicle has been booked by our user.Below are some of the details of the Owner which can help you to get started.</p></div>
                                                <div class="contentEditable" >
                                                    <p >Name : <?php echo $name;?></p>
                                                    <p >Contact : <?php echo $contact;?></p>
                                                    <p >Email : <?php echo $email;?></p>
                                                    <p >Vehicle number : <?php echo $vehicleNo;?></p>
                                                    <p >Vehicle name : <?php echo $vehicleName;?></p>
                                                </div>
											</div>
										</td>
										<td width="100">&nbsp;</td>
											...
											<table cellpadding="0" cellspacing="0" border="0" align="center" width="200" height="50">
												<tr>
													<td bgcolor="#ED006F" align="center" style="border-radius:4px;" width="200" height="50">
														<div class="contentEditableContainer contentTextEditable">
															<div class="contentEditable" >
																<a target='_blank' href="" class='link2'>Happy Renting!</a>
															</div>
														</div>
													...
													<td width="400" valign="top" style="padding-top:40px;padding-bottom:20px;">
														...
														<div class="contentEditableContainer contentTextEditable">
															<div class="contentEditable"  style="padding:20px 10px 0 0;margin:0;font-family:Helvetica, Arial, sans-serif;font-size:15px;line-height:150%;">
																<p style='color:#FFEECE;'>We are a dedicated ream of members who wants to provide a better vehicle services.</strong></p>
															</div>
														</div>
								...
								<table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
									...
									<tr>
										...
										<td width="500" align="left">
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" >
													<div style="font-family:Helvetica, Arial, sans-serif;font-size:16px;line-height:160%;color:#181818;font-weight:bold;">Dedicated</div>
												</div>
											</div>
											...
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" >
													<div style="font-family:Helvetica, Arial, sans-serif;font-size:16px;line-height:160%;color:#181818;font-weight:bold;">Effortless</div>
												</div>
											</div>
											<div style="height:20px;">&nbsp;</div>
											<div class="contentEditableContainer contentTextEditable">
											...
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" >
													<div style="font-family:Helvetica, Arial, sans-serif;font-size:16px;line-height:160%;color:#181818;font-weight:bold;"></div>
												</div>
											</div>
											<div style="height:20px;">&nbsp;</div>
											<div class="contentEditableContainer contentTextEditable">
												...
												<tr>
													<td width="600" valign="top">
														<div style="text-align:center;margin-bottom:-3px;">
															<div class="contentEditableContainer contentImageEditable">
																<div class="contentEditable" >
																	<img src="https://res.cloudinary.com/arihant95/image/upload/v1493750630/arihant_unyykv.png" height="200" width="200" alt='design images'  data-default="placeholder" data-max-width="200" />
                                                                    <img src="http://res.cloudinary.com/arihant95/image/upload/v1493750178/ayush_ndqsd6.jpg" height="200" width="200" alt='design images'  data-default="placeholder" data-max-width="200" />
																</div>
															</div>
														</div>
													</td>
